...
#include "..\PrototypeDriver\IOCTLs.h"
#include "..\PrototypeDriver\Common.h"
...
int main(int argc, const char* argv[])
{
    ...
    {
        // protect process
        printf("[+] Calling PROTOTYPE_DRIVER_DEVICE_PROTECT_PROCESS...");
        ...
        BOOL success = DeviceIoControl(
            hDriver,
            PROTOTYPE_DRIVER_PROTECT_PROCESS,
            &target,
            sizeof(target),
            nullptr,
            0,
    ...
    {
        // unprotect process
        printf("[+] Calling PROTOTYPE_DRIVER_DEVICE_UNPROTECT_PROCESS...");
        ...
        BOOL success = DeviceIoControl(
            hDriver,
            PROTOTYPE_DRIVER_UNPROTECT_PROCESS,
            &target,
            sizeof(target),
            nullptr,
            0,
    ...
    else if (strcmp(argv[1], "-t") == 0)
    {
        ...
        printf("[+] Calling PROTOTYPE_DRIVER_PROCESS_PRIVILEGE...");

        BOOL success = DeviceIoControl(
            hDriver,
            PROTOTYPE_DRIVER_PROCESS_PRIVILEGE,
            &target,
            sizeof(target),
            nullptr,
            0,
    ...
    else if (strcmp(argv[1], "-l") == 0)
    {
        ...
        printf("[+] Calling PROTOTYPE_DRIVER_ENUM_PROCESS_CALLBACK...");

        DWORD bytesReturned;
        BOOL success = DeviceIoControl(
            hDriver,
            PROTOTYPE_DRIVER_ENUM_PROCESS_CALLBACKS,
            nullptr,
            0,
            &callbacks,
            sizeof(callbacks),
    ...
    else if (strcmp(argv[1], "-r") == 0)
    {
        ...
        printf("[+] Calling PROTOTYPE_DRIVER_ZERO_PROCESS_CALLBACK...");

        BOOL success = DeviceIoControl(
            hDriver,
            PROTOTYPE_DRIVER_ZERO_PROCESS_CALLBACK,
            &target,
            sizeof(target),
            nullptr,
            0,
    ...
    else if (strcmp(argv[1], "-ci") == 0)
    {
        ...
        printf("[+] Calling PROTOTYPE_DRIVER_ENUM_DSE...");
    ...
    else if (strcmp(argv[1], "-ciE") == 0)
    {
        ...
        printf("[+] Calling PROTOTYPE_DRIVER_ENABLE_DSE...");

        BOOL success = DeviceIoControl(
            hDriver,
            PROTOTYPE_DRIVER_ENABLE_DSE,
            &dse,
            sizeof(dse),
            nullptr,
            0,
    ...
    else if (strcmp(argv[1], "-ciD") == 0)
    {
        ...
        printf("[+] Calling PROTOTYPE_DRIVER_DISABLE_DSE...");

        BOOL success = DeviceIoControl(
            hDriver,
            PROTOTYPE_DRIVER_DISABLE_DSE,
            &dse,
            sizeof(dse),
            nullptr,
            0,
